  ...
  return (
    <section className="portfolio--section" id="Portfolio">
      <div className="portfolio--container-box">
        ...
        <div>
          <a href="https://github.com/ShifaYahya" target="_blank" rel="noopener noreferrer" className="btn btn-github">
            <svg
        ...
        {data?.portfolio?.map((item, index) => (
          <div key={index} className="portfolio--section--card">
            <div className="portfolio--section--img">
              <img src={item.src} alt="Project Screenshot" />
            </div>
            <div className="portfolio--section--card--content">
              ...
              <div className="portfolio--buttons">
                <a href={item.linkUrl} target="_blank" rel="noopener noreferrer" className="portfolio--button">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
                ...
                <a href={item.liveUrl} target="_blank" rel="noopener noreferrer" className="portfolio--button">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
                  ...
                  >
                    <path d="M18,2 L22,2 L22,6 M22,12 L2,12 L2,2 L8,2"></path>
